...
$name_plural_low_case = 'staff members';
	...
	$args = array(
		'label'                 => $name,
		'description'           => $name_plural . ' are ' . $name_plural_low_case . ' at Evans Lake.',
		'labels'                => $labels,
...
$name = 'Activity';
$name_low_case = 'activity';
$name_plural = 'Activities';
$name_plural_low_case = 'activities';
	$labels = array(
		'name'                  => $name_plural,
		'singular_name'         => $name,
		'menu_name'             => $name_plural,
	...
	$args = array(
		'label'                 => $name,
		'description'           => $name_plural . ' are activities at Evans Lake.',
		'labels'                => $labels,
		'supports'              => array( 'title', 'revisions' ),
		'hierarchical'          => false,
		'public'                => true,
...
function register_camp_program_post_type() {
$name = 'Camp Program';
$name_low_case = 'camp program';
$name_plural = 'Camp Programs';
$name_plural_low_case = 'camp programs';
$name_registration_no_spaces_low_case = 'campprogram';
	$labels = array(
		'name'                  => $name_plural,
		'singular_name'         => $name,
		'menu_name'             => $name_plural,
	...
	register_post_type( $name_registration_no_spaces_low_case, $args );
}
add_action( 'init', 'register_camp_program_post_type', 0 );
