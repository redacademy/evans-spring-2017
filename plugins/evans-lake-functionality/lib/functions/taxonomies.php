...
function register_registration_period_type_taxonomy() {
  $name_up_plur = 'Registration Period Types';
  $name_up_sing = 'Registration Period Type';
  $name_low_plur = 'registration period types';
  $name_low_sing = 'registration period type';
  $name_low_reg = 'registrationperiodtype';
	$name_custom_post_type = 'registrationperiod';
...
add_action( 'init', 'register_registration_period_type_taxonomy', 0 );
